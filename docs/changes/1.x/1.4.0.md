...
- (esapm/PHPWord only) Word2007 TOC and TOF: Changes PAGEREF reference from relationshipId to _Toc{$elementId} and extends $elementId from 6 to 9 characters to better emulate Word functionality [@esapm](https://github.com/esapm)
- (esapm/PHPWord only) Word2007 Captions: Improves formatting. See docs/usage/element/caption.md [@esapm](hhttps://github.com/esapm/PHPWord/blob/merge-with-PHPOffice-1.4.0/docs/usage/elements/caption.md)
- (esapm/PHPWord only) Word2007 Titles (headings): Allows comments to be added to titles (headings) [@esapm](hhttps://github.com/esapm/PHPWord/blob/merge-with-PHPOffice-1.4.0/docs/usage/elements/caption.md)
